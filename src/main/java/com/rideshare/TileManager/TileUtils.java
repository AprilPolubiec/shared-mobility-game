...
public class TileUtils {
    public static final Integer[] ROAD_TILE_IDS = { 109, 110, 111, 112, 127, 128, 129, 130, 145, 146, 147, 148, 163, 164,
            165, 166 };
    public static final Integer[] STOP_TILE_IDS = { 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 199, 200 };
    public static final Integer[] GRASS_TILE_IDS = { 1, 2, 3 };
    public static final Integer[] TRAIN_TILE_IDS = { 59, 43, 60, 61, 78, 79, 199, 200 };
